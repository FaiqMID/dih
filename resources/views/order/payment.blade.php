    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-6 d-grid">
                ...
                <form id="form-bayar" action="/pay" method="post">
                    @csrf
                    <input type="hidden" name="id_order" value="{{ $info_pembayaran['id_order'] }}">
                    <input type="hidden" name="total" value="{{ $info_pembayaran['total'] }}">
                    <div class="btn-group-vertical mt-3" role="group" aria-label="Vertical radio toggle button group">
                        ...
                        <input type="radio" class="btn-check" name="pay_method" id="vbtn-radio2" autocomplete="off" value="midtrans" checked="checked">
                        ...
                        <input type="radio" class="btn-check" name="pay_method" id="vbtn-radio4" autocomplete="off" value="cod">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                <main class="form-signin">
                                    <h1 class="h3 mb-3 fw-normal text-center">Proses pesanan?</h1>
                                    <button class="w-100 btn btn-success mt-3" id="pay-button">Konfirmasi</button>
                                </main>
                                ...
                                <script type="text/javascript">
                                    ...
                                    if (document.querySelector('input[name="pay_method"]:checked').value === "midtrans" ){
